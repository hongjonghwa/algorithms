...
int bigrand()
{
	//return RAND_MAX*rand() + rand(); // VS RAND_MAX = 0x7FFF
	return rand(); // GCC RAND_MAX = 0x7FFFFFFF
}
...
//	for (int i = 0; i < 2; i++)
//		cout << v[i] << "\n";
	cout << " Time : " << ((double)clock() - clk) / CLOCKS_PER_SEC << endl;
